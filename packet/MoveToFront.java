...
public class MoveToFront {
	...
	public static void encode(BinaryIn in, BinaryOut out) {
		...
		//Grímur: Basically we need to arrange the input file differently
		//Grímur: And Output it as out
		//Grímur: Sadly the specifics are not available right now but will tomorrow, teachers are
		//Grímur: Not prepared to help with this just yet.
		//Grímur: Decode is the same but in reverse, returning the arranged file out into the original in
	}
